            ...
            <div className="flex items-center justify-between px-6 h-16 w-full max-w-[1600px] mx-auto">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <a
                        ...
                        className="inline-flex items-center gap-1.5 text-xs font-bold px-3 py-1.5 rounded-lg bg-[#25D366]/10 hover:bg-[#25D366]/20 text-[#25D366] border border-[#25D366]/20 hover:border-[#25D366]/40 transition-all hover:-translate-y-0.5 active:scale-95"
                    >
