...
import { LayoutDashboard, Users, PenTool, BarChart, Library } from "lucide-react";
import { motion } from "framer-motion";

const navItems = [
    { label: "Dashboard", href: "/admin", icon: LayoutDashboard },
    { label: "Tests", href: "/admin/management", icon: Library },
    { label: "Users", href: "/admin/users", icon: Users },
    { label: "CMS", href: "/admin/cms", icon: PenTool },
