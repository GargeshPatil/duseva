...
export function TrustSection() {
    return (
        <section className="py-10 bg-surface-elevated border-y border-border overflow-hidden">
                ...
                >
                    {[...colleges, ...colleges, ...colleges].map((college, idx) => (
                        <div key={idx} className="mx-8 lg:mx-12">
                            <span className="text-xl md:text-2xl font-bold text-text-muted/50 hover:text-text-muted transition-colors cursor-default select-none">
                                {college}
                            </span>
                        </div>
                    ))}
